...
export const searchImage = async (req, res) => {
  try {
    ...
    if (req.file) {
      ...
      console.log("🧠 Received base64 image in body");
      imageBase64 = req.body.imageBase64;
    } else {
      return res.status(400).json({ error: "No image provided" });
    }

    // 🧩 TODO: your model logic here (replace this block)
    console.log("Processing image...");
    // Simulate successful result
    const result = {
      matches: [
        { id: 1, name: "Sample Item", score: 0.98 },
        { id: 2, name: "Similar Item", score: 0.92 },
      ],
    };
